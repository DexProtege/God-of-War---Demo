...
public class EnemyLockOn : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetKeyDown(KeyCode.Mouse2) || PlayerController.instance.isEnemyLockOn)
        {
            if (PlayerController.instance.isEnemyLockOn)
                PlayerController.instance.isEnemyLockOn = false;
